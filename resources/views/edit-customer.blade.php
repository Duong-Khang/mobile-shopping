...
<head>
  ...
  <!-- css -->
  <link rel="stylesheet"
    href="../Admin/vendor/bootstrap/css/bootstrap.ltr.css" />
  <link rel="stylesheet"
    href="../Admin/vendor/highlight.js/styles/github.css" />
  ...
  <link rel="stylesheet"
    href="../Admin/vendor/air-datepicker/css/datepicker.min.css" />
  <link rel="stylesheet" href="../Admin/vendor/select2/css/select2.min.css" />
  <link rel="stylesheet"
    href="../Admin/vendor/datatables/css/dataTables.bootstrap5.min.css" />
...
<body>
  ...
  <div
    ...
    <div class="sa-app__sidebar">
      <div class="sa-sidebar">
        <div style="background-color: white;" class="sa-sidebar__header"><a
            class="sa-sidebar__logo" href="../../Admin/">
            <!-- logo -->
            ...
            <li class="sa-nav__section">
              ...
              <ul class="sa-nav__menu sa-nav__menu--root">
                ...
                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"><a
                    href="../../Admin/" class="sa-nav__link"><span
                ...
                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                  data-sa-collapse-item="sa-nav__menu-item--open"><a href="#"
                    class="sa-nav__link" data-sa-collapse-trigger=""><span
                      ...
                      phẩm</span><span class="sa-nav__arrow"><svg
                  ...
                  <ul class="sa-nav__menu sa-nav__menu--sub"
                    ...
                    <li class="sa-nav__menu-item"><a
                        href="../../Admin/app-product-list.php"
                        class="sa-nav__link"><span
                          class="sa-nav__menu-item-padding"></span><span
                          class="sa-nav__title">Danh sách sản phẩm</span></a>
                    </li>

                    <li class="sa-nav__menu-item"><a
                        href="../../Admin/app-category-list.php"
                        class="sa-nav__link"><span
                          class="sa-nav__menu-item-padding"></span><span
                          class="sa-nav__title">Danh mục sản phẩm</span></a>
                    </li>
                ...
                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                  data-sa-collapse-item="sa-nav__menu-item--open"><a href="#"
                    class="sa-nav__link" data-sa-collapse-trigger=""><span
                      ...
                      hàng</span><span class="sa-nav__arrow"><svg
                        xmlns="http://www.w3.org/2000/svg" width="6" height="9"
                        viewBox="0 0 6 9" fill="currentColor">
                        <path
                          d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                  ...
                  <ul class="sa-nav__menu sa-nav__menu--sub"
                    data-sa-collapse-content="">
                    <li class="sa-nav__menu-item"><a
                        href="http://localhost:8080/ThucTapTwo/Admin/app-customer-list"
                        class="sa-nav__link"><span
                          class="sa-nav__menu-item-padding"></span><span
                          class="sa-nav__title">Danh sách khách hàng</span></a>
                    </li>
                ...
                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                  ...
                  <ul class="sa-nav__menu sa-nav__menu--sub"
                    data-sa-collapse-content="">
                    <li class="sa-nav__menu-item"><a
                        href="http://localhost:8080/ThucTapTwo/Admin/app-order-list"
                        class="sa-nav__link"><span
                          class="sa-nav__menu-item-padding"></span><span
                          class="sa-nav__title">Danh sách đơn đặt
                          hàng</span></a></li>
                ...
                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                  data-sa-collapse-item="sa-nav__menu-item--open"><a href="#"
                    class="sa-nav__link" data-sa-collapse-trigger=""><span
                      ...
                      mãi</span><span class="sa-nav__arrow"><svg
                        xmlns="http://www.w3.org/2000/svg" width="6" height="9"
                        viewBox="0 0 6 9" fill="currentColor">
                        <path
                          d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                  ...
                  <ul class="sa-nav__menu sa-nav__menu--sub"
                    data-sa-collapse-content="">
                    <li class="sa-nav__menu-item"><a
                        href="../../Admin/app-discount-list.php"
                        class="sa-nav__link"><span
                          class="sa-nav__menu-item-padding"></span><span
                          class="sa-nav__title">Danh sách khuyến mãi</span></a>
                    </li>
                    <li class="sa-nav__menu-item"><a
                        href="../../Admin/app-code-list.php"
                        class="sa-nav__link"><span
                          class="sa-nav__menu-item-padding"></span><span
                          class="sa-nav__title">Danh sách mã giảm giá</span></a>
                    </li>
                ...
                <li>
                  <ul class="sa-nav__menu sa-nav__menu--root">
                    <li style="position: absolute; bottom: 0;"
                      class="sa-nav__menu-item sa-nav__menu-item--has-icon"><a
                        id="my-logout" style="width: 240px;"
                        href="../../Admin/logout.php" class="sa-nav__link"><span
                          class="sa-nav__icon"><i
                            class="fas fa-sign-out-alt"></i></span><span
                          class="sa-nav__title">Đăng xuất</span></a>
                    </li>
                  </ul>
                </li>
              </ul>
    ...
    <div class="sa-app__content">
      ...
      <div class="sa-toolbar sa-toolbar--search-hidden sa-app__toolbar">
        <div class="sa-toolbar__body">
          <div class="sa-toolbar__item"><button class="sa-toolbar__button"
              type="button" aria-label="Menu" data-sa-toggle-sidebar=""><svg
          ...
          <div class="sa-toolbar__item d-sm-none"><button
              class="sa-toolbar__button" type="button" aria-label="Show search"
              data-sa-action="show-search"><svg
          ...
          <div class="dropdown sa-toolbar__item"><button class="sa-toolbar-user"
              type="button" id="dropdownMenuButton" data-bs-toggle="dropdown"
              data-bs-offset="0,1" aria-expanded="false"><span
                class="sa-toolbar-user__avatar sa-symbol sa-symbol--shape--rounded"><img
                  src="../Admin/images/user1.png" width="64" height="64"
                  alt="" /></span><span class="sa-toolbar-user__info"><span
                  class="sa-toolbar-user__title">
                  ...
                  class="sa-toolbar-user__subtitle"></span></span></button>
            <ul class="dropdown-menu w-100"
              aria-labelledby="dropdownMenuButton">
              <li><a class="dropdown-item"
                  href="../../Admin/change-password.php">Đổi mật khẩu</a></li>
              <li>
              ...
              <div class="sa-entity-layout__body">
                <div class="sa-entity-layout__main">
                  ...
                  <div style="margin-top: 20px;" class="col-auto d-flex">
                    <a id="btn_editCustomer" class="btn btn-primary">Cập
                      nhật</a>
                  </div>
                </div>
              </div>
  ...
  <script src="../Admin/vendor/fontawesome/js/all.min.js"
    data-auto-replace-svg="" async=""></script>
...
$(document).ready(function() {
  ...
  $("#btn_editCustomer").click(function() {
    ...
    $.ajax({
      url: "{{route('sua-tai-khoan-khach-hang')}}",
      type: "post",
      dataType: "text",
      data: {
        username: username,
