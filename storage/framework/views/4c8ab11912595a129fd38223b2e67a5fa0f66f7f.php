        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="module-one">
                ...
                <div id="style_load_more">
                    <a href="<?php echo e(route('shop')); ?>"><input id="btn_load_more" class="btn btn-secondary" type="button" value="Xem thêm"></a>
                </div>
                <style>
                    #style_load_more{
                        display: flex;
...
</div><?php /**PATH D:\xampp\htdocs\ThucTapTwo\resources\views/layout/home-product-module.blade.php ENDPATH**/ ?>