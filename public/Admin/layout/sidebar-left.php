...
<script>
    ...
    setInterval(function() {
        $.ajax({
            url: "Controller/ControllerCheckValidCode.php",
            type: "get",
            dataType: "json",
            data: {
                day: day,
            ...
            success: function(result) {
                for (let i = 0; i < result.length; i++) {
                    ...
                    if (check <= 0) {
                        ...
                        $.ajax({
                            url: "Controller/ControllerUpdateStatusCodeTimeExpired.php",
                            type: "get",
                            dataType: "text",
                            data: {
                                end_date: end_date
    ...
    setInterval(function() {
        $.ajax({
            url: "Controller/ControllerCheckValidDiscount.php",
            type: "get",
            dataType: "json",
            data: {
                day: day,
            ...
            success: function(result) {
                for (let i = 0; i < result.length; i++) {
                    ...
                    if (check <= 0) {
                        ...
                        //Gửi ajax để cập nhật trạng thái
                        $.ajax({
                            url: "Controller/ControllerUpdateStatusDiscountTimeExpired.php",
                            type: "get",
                            dataType: "json",
                            data: {
                                end_date: end_date
