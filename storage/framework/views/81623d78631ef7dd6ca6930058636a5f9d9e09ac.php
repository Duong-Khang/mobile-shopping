                                    ...
                                    <div class="card">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="mb-4"><label for=""
                                                    class="form-label">Mật khẩu</label><input type="password"
...
<script>
    $(document).ready(function(){
        ...
        $("#btn_addCustomer").click(function(){
            ...
            //Gửi ajax
            $.ajax({
                url: "<?php echo e(route('them-khach-hang')); ?>",
                type: "post",
                dataType: "text",
                data: {
                    username: username,
...
<?php
    ob_flush();
?><?php /**PATH D:\xampp\htdocs\ThucTapTwo\resources\views/add-customer.blade.php ENDPATH**/ ?>