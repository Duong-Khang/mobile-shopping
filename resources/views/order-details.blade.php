                  ...
                  <form action="#">
                    <div class="table-responsive text-center wishlist-style">
                      <table class="table table-bordered">
                        ...
                        {{-- Lấy thông tin của người mua hàng --}}
                        <script>
                        $(document).ready(function() {
                          ...
                          if (user !== user_login) {
                            window.location.replace(
                              'http://localhost:8080/ThucTapTwo/public/');
                          }
                          //Gửi ajax
                          $.ajax({
                        ...
                        <table class="table table-bordered">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><span id="show_value_discount"
                                  class="color-primary">0 đ</span></td>
                            </tr>
                            <tr>
                              <td><strong>Thành tiền:</strong></td>
                              <td><span id="order_tong"
                                  class="color-primary">$860.00</span></td>
                            </tr>
