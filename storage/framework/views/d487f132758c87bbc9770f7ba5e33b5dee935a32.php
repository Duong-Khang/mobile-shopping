           ...
           <div class="row">
                        ...
                        <script>
                            $(document).ready(function(){
                                ...
                                $.ajax({
                                    ...
                                    success: function(result){
                                        $("#show_result_filter").html(result);
                                        //$("#show_result_filter_").html(result);
                                    }
                                });
                                //Giá từ 10m-20m
               ...
               <div class="col-lg-9 order-first order-lg-last">
                    <div class="product-shop-main-wrapper mb-50">
                        ...
                        <div id="show_result_filter_" class="shop-product-wrap grid row">
...
<?php /**PATH D:\xampp\htdocs\ThucTapTwo\resources\views/apple.blade.php ENDPATH**/ ?>