                        ...
                        <li class="sa-nav__section">
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--root">
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" class="sa-nav__link" data-sa-collapse-trigger=""><span class="sa-nav__icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                                    ...
                                    <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                        <li class="sa-nav__menu-item"><a href="../../Admin/app-customer-list.php" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh sách khách hàng</span></a></li>
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" class="sa-nav__link" data-sa-collapse-trigger=""><span class="sa-nav__icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                                    ...
                                    <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                        <li class="sa-nav__menu-item"><a href="../../Admin/app-order-list.php" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh sách đơn đặt hàng</span></a></li>
                                ...
                                <div class="sa-entity-layout__main">
                                    <div class="card">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="mb-4"><label for="" class="form-label">Mật khẩu</label><input type="password" id="password" class="form-control" />
                                            </div>
                                            <div class="mb-4"><label for="" class="form-label">Nhập lại mật khẩu</label><input type="password" id="cpassword" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php
ob_flush();
?><?php /**PATH D:\PHP\xampp\htdocs\ThucTapTwo\resources\views/add-customer.blade.php ENDPATH**/ ?>