...
<head>
  ...
  <title>Danh sách khuyến mãi</title><!-- icon -->
                  ...
                  <nav class="mb-2" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-sa-simple">
                      <li class="breadcrumb-item"><a href="../Admin/">Trang
                          chủ</a></li>
                      <li class="" aria-current="page"> / Danh sách khuyến mãi
                      </li>
                    </ol>
                  </nav>
                </div>
                <div class="col-auto d-flex"><a href="../Admin/add-discount.php"
                    class="btn btn-primary">Thêm khuyến mãi</a></div>
              </div>
            </div>
            <div class="card">
              <div class="p-4"><input type="text" placeholder="Tìm"
                ...
                <tbody>
                  ...
                  <tr>
                    <td><input type="checkbox"
                        ...
                        aria-label="..." /></td>
                    <td><a
                        href="../Admin/edit-discount.php?did=<?php echo $row['id'] ?>"
                      ...
                      <div id="status_<?php echo $row['id'] ?>"
                        ...
                        <?php
                                                        if ($row['active'] == 1) {
                                                            ...
                                                            echo '<div class="badge badge-sa-pill badge-sa-warning">Đã hết hạn</div>';
                    ...
                    <td>
                      <div id="updateDelete_<?php echo $row['id'] ?>"
                      ...
                      <div class="dropdown"><button
                        ...
                        <ul class="dropdown-menu dropdown-menu-end"
                          ...
                          <li><a class="dropdown-item"
                              href="../Admin/edit-discount.php?did=<?php echo $row['id'] ?>">Sửa</a>
                          </li>
                          ...
                          <li id="check_<?php echo $row['id'] ?>"><a
                              ...
                              id="btn_deleteDiscount_<?php echo $row['id'] ?>"
                              class="dropdown-item text-danger">Xóa</a></li>
                          <input type="hidden" id="did_<?php echo $row['id'] ?>"
                          ...
                          $(document).ready(function() {
                            ...
                            //Lấy discount id
                            var did = $("#did_<?php echo $row['id'] ?>")
                              .val();
                            //Gửi ajax
                            $.ajax({
                              url: "Controller/ControllerCheckDeleteDiscount.php",
                              type: "get",
                              dataType: "text",
                              data: {
                                did: did
                            ...
                            $("#btn_deleteDiscount_<?php echo $row['id'] ?>")
                              .click(function() {
                                ...
                                if (answer) {
                                  //Lấy discount id
                                  var did = $(
                                      "#did_<?php echo $row['id'] ?>")
                                    .val();
                                  //Gửi ajax
                                  $.ajax({
                                    url: "Controller/ControllerDeleteDiscount.php",
                                    type: "get",
                                    dataType: "json",
                                    data: {
                                      did: did
