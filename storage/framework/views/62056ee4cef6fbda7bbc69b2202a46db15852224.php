                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div id="show_input_discount" class="">
                                        ...
                                        font-weight: 400;margin-bottom: 30px;"><i style="font-size: 20px;" class="fas fa-envelope"></i> Có phiếu giảm giá? <span style="cursor: pointer" id="show_coupon"><button class="btn btn-secondary">Nhập mã</button></span></h3>
                                            ...
                                            <div class="coupon-info">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-sm-12 col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" name="" value="" placeholder="Nhập mã" id="input_discount_code" class="form-control mr-3">
                                                                <input type="submit" value="Áp dụng" id="btn_discount_code" class="btn btn-secondary">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                                ...
                                                <script>
                                                    $(document).ready(function() {
                                                        ...
                                                        $.ajax({
                                                            url: "<?php echo e(route('kiem-tra-discount-code')); ?>",
                                                            type: "get",
                                                            dataType: "text",
                                                            data: {
                                                                customer: customer
                                                            ...
                                                            success: function(testDiscountCode) {
                                                                if (testDiscountCode != 0) {
                                                                    ...
                                                                    $("#row_total_all").append('<tr class="order-total"><th>Mã giảm giá</th><td class="text-center"><strong>' + code + '</strong></td></tr>');
                                                                }
                                                            }
                                                        });
                                                        ...
                                                        $("#btn_discount_code").click(function() {
                                                            //Lấy code
                                                            var value_code = $("#input_discount_code").val();
                                                            if (!value_code) {
                                                            ...
                                                            //Gửi ajax
                                                            $.ajax({
                                                                url: "<?php echo e(route('set-discount-code')); ?>",
                                                                type: "get",
                                                                dataType: "json",
                                                                data: {
                                                                        ...
                                                                        if (item['error'] != 'success') {
                                                                            ...
                                                                            $.ajax({
                                                                                ...
                                                                                success: function(result_) {
                                                                                    ...
                                                                                    result_ = Math.round(result_);
                                                                                    result_ = numberFormat.format(result_);

                                                                                    //$("#tam_tinh").html(result_);
                                                                                    $("#tong_tien").html(result_);
                                                                                }
                                                                            });
                                                                        }
                                                                    });
                                        ...
                                        <form id="form_checkout">
                                            <div class="form-row mb-3">
                                                <div class="form-group col-12 col-sm-12 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="fullname_checkout" required>
                                                </div>
                                                <div class="form-group col-12 col-sm-12 col-md-6">
                                                    <label for="last_name">Số điện thoại <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="phone_checkout" required>
                                                </div>
                                            </div>
                                            <div class="form-row mb-3">
                                                <div class="form-group col-12 col-sm-12 col-md-6">
                                                    <label for="company_name">Email</label>
                                                    <input type="email" class="form-control" id="email_checkout">
                                                </div>
                                                <div class="form-group col-12 col-sm-12 col-md-6">
                                                    <label for="email_address">Địa chỉ <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="address_checkout" required>
                                                </div>
                                            </div>
                                        </form>
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-5">
                                    <div class="order-summary">
                                                ...
                                                <table class="table table-bordered">
                                                    <tbody id="row_total_all">
                                                        <tr class="cart-subtotal">
                                                            <th>Tạm tính</th>
                                                            <td class="text-center"><span id="tam_tinh"></span></td>
                                                        </tr>
                                                        <tr class="order-total">
                                                            <th>Tổng tiền</th>
                                                            <td class="text-center"><strong id="tong_tien"></strong></td>
                                        ...
                                        <div class="form-row justify-content-end">
                                            <input id="btn_checkout" type="submit" class="btn btn-secondary dark" value="Mua hàng">
                                        </div>
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result !== "error") {
                        ...
                        //alert("Success");
                        window.location.replace('http://localhost:8080/ThucTapTwo/public/order-list');
                    } else {
                        alert("Thất bại");
                    }
                }
...
</script><?php /**PATH D:\PHP\xampp\htdocs\ThucTapTwo\resources\views/checkout.blade.php ENDPATH**/ ?>