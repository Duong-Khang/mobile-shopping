        ...
        <div class="col-12">
          <div class="breadcrumb-wrap">
            <nav aria-label="breadcrumb">
              <ul class="breadcrumb">
                <li class="breadcrumb-item"><a>Trang chủ</a>
                </li>
        ...
        <div class="col-lg-3">
          <div class="shop-sidebar-inner mb-30">
            ...
            $(document).ready(function() {
              $("#btn_price").click(function() {
                ...
                if (apdungFrom == '') {
                  alert(
                    "Bạn chưa điền giá bắt đầu");
                  return false;
                }

                if (apdungTo == '') {
                  alert(
                    "Bạn chưa điền giá kết thúc");
                  return false;
                }
                ...
                <div class="filter-attribute-container">
                  <ul>
                    ...
                    <li><a id="btn_white_hide"
                        style="cursor: pointer;">Trắng</a>
                    </li>
                    <li><a id="btn_green" style="cursor: pointer;">Xanh</a>
                    </li>
                    <li><a id="btn_green_hide" style="cursor: pointer;">Xanh</a>
                    </li>
                    <li><a id="btn_black" style="cursor: pointer;">Đen</a>
                    </li>
                    <li><a id="btn_black_hide" style="cursor: pointer;">Đen</a>
                    </li>
                    <li><a id="btn_violet" style="cursor: pointer;">Tím</a>
                    </li>
                    <li><a id="btn_violet_hide" style="cursor: pointer;">Tím</a>
                    </li>
                    <li><a id="btn_silver" style="cursor: pointer;">Bạc</a>
                    </li>
                    <li><a id="btn_silver_hide" style="cursor: pointer;">Bạc</a>
                    </li>
                    <li><a id="btn_gray" style="cursor: pointer;">Xám</a>
                    </li>
          ...
          $(document).ready(function() {
            ...
            $("#btn_white").click(function() {
              $("#btn_white_hide").show();
              $("#btn_white_hide").addClass(
                "active");
              var color = $(this).text();
              $(this).hide();
              var urlPage = window.location
                .pathname;
              var new_url = urlPage + "?color=" +
                color;
