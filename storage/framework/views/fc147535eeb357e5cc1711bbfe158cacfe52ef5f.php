...
<body>
    <input type="hidden" name="" id="value_product" value="Xiaomi">
    <!-- header area start -->
                    ...
                    <div class="breadcrumb-wrap">
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Danh mục xiaomi</li>
                            </ul>
                        </nav>
                    </div>
                </div>
...
</html> <?php /**PATH D:\PHP\xampp\htdocs\ThucTapTwo\resources\views/xiaomi-temp.blade.php ENDPATH**/ ?>