                            ...
                            <ul class="sa-nav__menu sa-nav__menu--root">
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" class="sa-nav__link" data-sa-collapse-trigger=""><span class="sa-nav__icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                                    ...
                                    <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                        <li class="sa-nav__menu-item"><a href="../../Admin/app-product-list.php" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh sách sản phẩm</span></a></li>

                                        <li class="sa-nav__menu-item"><a href="../../Admin/app-category-list.php" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh mục sản phẩm</span></a></li>
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" class="sa-nav__link" data-sa-collapse-trigger=""><span class="sa-nav__icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                                    ...
                                    <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                        <li class="sa-nav__menu-item"><a href="../../Admin/app-discount-list.php" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh sách khuyến mãi</span></a></li>
                                        <li class="sa-nav__menu-item"><a href="../../Admin/app-code-list.php" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh sách mã giảm giá</span></a></li>
                                ...
                                <div class="col">
                                    <nav class="mb-2" aria-label="breadcrumb">
                                        <ol class="breadcrumb breadcrumb-sa-simple">
                                            ...
                                            <li class=""><a href="../../Admin/app-customer-list.php"> / Danh sách khách hàng</a></li>
                                    ...
                                    <div class="card">
                                        ...
                                        ?>
                                            <div class="card-body p-5">
                                                <div class="mb-4"><label for="form-category/name" class="form-label">Tên tài khoản</label><input id="username" type="text" class="form-control" value="<?php echo $row['username'] ?>" disabled />
                                                </div>

                                                <div class="mb-4"><label for="" class="form-label">Mật khẩu</label><input type="password" value="<?php echo $row['password'] ?>" id="password" class="form-control" />
                                                </div>
                                                <div class="mb-4"><label for="" class="form-label">Nhập lại mật khẩu</label><input type="password" id="cpassword" class="form-control" value="<?php echo $row['password'] ?>" />
                                                </div>
                                                <div class="mb-4">
                                                    <div class="mb-5">
...
<?php
ob_flush();
?><?php /**PATH D:\PHP\xampp\htdocs\ThucTapTwo\resources\views/edit-customer.blade.php ENDPATH**/ ?>