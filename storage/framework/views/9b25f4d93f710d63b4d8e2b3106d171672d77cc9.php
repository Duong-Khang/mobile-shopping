    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-4 col-12">
                    ...
                    <ul>
                        <li class="settings">                 
                            ...
                            ?>
                                ...
                                <ul id="dashboard_user" class="box-dropdown ha-dropdown">
                ...
                <div class="box box-right" id="show_check_login_success">
                    <ul>
                        <li class="settings">
...
</script><?php /**PATH D:\Program Files\XamPP\htdocs\ThucTapTwo\resources\views/layout/header-top.blade.php ENDPATH**/ ?>