                ...
                <div class="top-main-menu">
                    <div class="categories-menu-bar">
                        <nav id="btn_show" class="categorie-menus ha-dropdown">
                            <ul id="menu2">
                                <li>
                                    <a href="<?php echo e(route('apple')); ?>">Apple<span class="lnr lnr-chevron-right"></span></a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('xiaomi')); ?>">Xiaomi<span class="lnr lnr-chevron-right"></span></a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('oppo')); ?>">OPPO<span class="lnr lnr-chevron-right"></span></a>
                                </li>
                                <li>
...
</div><?php /**PATH D:\xampp\htdocs\ThucTapTwo\resources\views/layout/header-top-menu.blade.php ENDPATH**/ ?>