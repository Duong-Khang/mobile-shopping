        ...
        <div class="pro-module-four-active owl-carousel owl-arrow-style">
            ...
            <div class="product-module-four-item">
                <div style="height: 150px;" class="product-module-caption">
                    ...
                    <input type="hidden" name="" id="pid__<?php echo $row['id'] ?>" value="<?php echo $row['id'] ?>">
                        ...
                        $(document).ready(function(){
                            ...
                            $.ajax({
                                ...
                                success: function(result){
                                    $("#show_star__<?php echo $row['id'] ?>").html(result);
                                    //alert(result)
                                }
                            });
                        });
...
</div><?php /**PATH D:\Program Files\XamPP\htdocs\ThucTapTwo\resources\views/layout/home-product-module-five.blade.php ENDPATH**/ ?>