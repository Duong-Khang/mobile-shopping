...
<!-- Mirrored from stroyka-admin.html.themeforest.scompiler.ru/variants/ltr/page-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Sep 2021 08:12:26 GMT -->
    ...
    <div class="sa-app sa-app--desktop-sidebar-shown sa-app--mobile-sidebar-hidden sa-app--toolbar-fixed">
        ...
        <div class="sa-app__sidebar">
            <div class="sa-sidebar">
                <div class="sa-sidebar__header"><a class="sa-sidebar__logo" href="index.html">
                        <!-- logo -->
            ...
            <div id="top" class="sa-app__body">
                <div class="sa-error">
                    ...
                    <div class="sa-error__content">
                        ...
                        <p class="sa-error__text">We can&#x27;t seem to find the page you&#x27;re looking for.<br />Try
                            to use the search.</p>
                        <form class="sa-error__controls"><input type="text" placeholder="Search..."
                                class="form-control form-control--search-filled sa-error__input" /><button type="submit"
                                class="btn btn-primary">Search</button></form>
                        <p class="sa-error__text">Or go to the home page to start over.</p><a
...
</html><?php /**PATH D:\xampp\htdocs\ThucTapTwo\resources\views/404.blade.php ENDPATH**/ ?>