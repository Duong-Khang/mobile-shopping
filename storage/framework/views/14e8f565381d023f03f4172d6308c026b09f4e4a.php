...
<body>
    <input type="hidden" name="" id="value_product" value="Samsung">
    <!-- header area start -->
                    ...
                    <div class="breadcrumb-wrap">
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Danh mục samsung</li>
                            </ul>
                        </nav>
                    </div>
                </div>
           ...
           <div class="row">
                                         ...
                                         <div class="filter-price-wapper">
                                             <div class="filter-price-cont">
                                                 <div class="input-type">
                                                     <input style="width: 100px; border: 1px solid #6c757d;" id="min-price" type="text">
                                                 </div>
                                                 <div class="input-type">
                                                     <input style="width: 100px; border: 1px solid #6c757d;" id="max-price" type="text">
                                                 </div>
                                             ...
                                             <div>
                                                <input id="btn_price" class="btn btn-secondary" type="submit" value="Áp dụng">
                                            </div>
                                         </div>
                         ...
                         <div class="single-sidebar mb-45">
                             ...
                             <div class="sidebar-content-box">
                                 <div class="filter-attribute-container">
                                     <ul>
                                         <li><a id="btn_32" style="cursor: pointer;" onclick="changeurl(32, '')">32GB</a></li>
                                         <li><a id="btn_32_hide" style="cursor: pointer;" onclick="changeurlHide(32)">32GB</a></li>
                                         <li><a id="btn_64" style="cursor: pointer;" onclick="changeurl(64, '')">64GB</a></li>
                                         <li><a id="btn_64_hide" style="cursor: pointer;" onclick="changeurlHide(64)">64GB</a></li>
                                         <li><a id="btn_128" style="cursor: pointer;" onclick="changeurl(128, '')">128GB</a></li>
                                         <li><a id="btn_128_hide" style="cursor: pointer;" onclick="changeurlHide(128)">128GB</a></li>
                                         <li><a id="btn_256" style="cursor: pointer;" onclick="changeurl(256, '')">256GB</a></li>
                                         <li><a id="btn_256_hide" style="cursor: pointer;" onclick="changeurlHide(256)">256GB</a></li>
                                     </ul>
                                 </div>
                             </div>
                         </div>
                         ...
                         <script>
                           $(document).ready(function(){
                                ...
                                $("#btn_32").click(function(){
                                    ...
                                    $("#btn_256_hide").hide();
                                    $("#btn_256").show();
                                    const rom =  new URLSearchParams(window.location.search).get('filter');
                                    console.log(rom);
                             ...
                             <div class="sidebar-content-box">
                                 <div class="filter-attribute-container">
                                     <ul>
                                        ...
                                        <li><a id="btn_white_hide" style="cursor: pointer;">Trắng</a></li>
                                        <li><a id="btn_green" style="cursor: pointer;">Xanh</a></li>
                                        <li><a id="btn_green_hide" style="cursor: pointer;">Xanh</a></li>
                                        <li><a id="btn_black" style="cursor: pointer;">Đen</a></li>
                                        <li><a id="btn_black_hide" style="cursor: pointer;">Đen</a></li>
                                        <li><a id="btn_violet" style="cursor: pointer;">Tím</a></li>
                                        <li><a id="btn_violet_hide" style="cursor: pointer;">Tím</a></li>
                                        <li><a id="btn_silver" style="cursor: pointer;">Bạc</a></li>
                                        <li><a id="btn_silver_hide" style="cursor: pointer;">Bạc</a></li>
                                        <li><a id="btn_gray" style="cursor: pointer;">Xám</a></li>
                                        <li><a id="btn_gray_hide" style="cursor: pointer;">Xám</a></li>
                                     </ul>
                                 </div>
                             </div>
                         </div>
                    ...
                    <script>
                     ...
                     <div class="single-sidebar mb-30">
                         <div class="sidebar-thumb">
                             <a href="#"><img style="margin-bottom: 10px;" src="assets/img/banner/img-static-sidebar-change.jpg" alt=""></a>
                         </div>
                     </div>
               ...
               <div class="col-lg-9 order-first order-lg-last">
                    <div class="product-shop-main-wrapper mb-50">
                        ...
                        <div id="show_result_filter" class="shop-product-wrap grid column_3 row">                          
                        </div>    
                    </div>
               </div>
           </div>
...
</html> <?php /**PATH D:\xampp\htdocs\ThucTapTwo\resources\views/samsung-temp.blade.php ENDPATH**/ ?>