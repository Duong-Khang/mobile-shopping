                ...
                <div style="padding-top: 40px; padding-bottom: 15px; "
                  ...
                  <div class="form-group row align-items-center mb-4">
                    ...
                    <div class="col-12 col-sm-12 col-md-8">
                      ...
                      <button class="pass-show-btn" id="showPassword"
                        type="button">Hiển thị</button>
                    </div>
                  </div>
                  <div class="login-box mt-0 text-center">
                    <button type="submit" id="btn_login"
                      class="btn btn-secondary mb-2 mt-0">Đăng nhập</button>
                  </div>
                  <div class="text-center pt-2 top-bordered">
                    <p>Chưa có tài khoản? <a href="{{route('dang-ky')}}">Tạo tài
                        khoản</a>.</p>
                  </div>
                  {{-- </form> --}}
                </div>
...
{{-- JS xửa lý khi nhấn vào nút đăng nhập --}}
<script>
