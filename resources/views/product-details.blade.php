...
<body>
        ...
        <div class="col-lg-5">
          <div class="product-large-slider mb-20">
            <div id="show_img_big" class="pro-large-img">
              ...
              <div class="img-view">
                <a class="img-popup"
                  href="product_images_desc/<?php echo $row['photo_color1'] ?>"></a>
            ...
            <div class="product-details-contentt">
              ...
              <div class="pro-details-list pt-20">
                <ul>
                  ...
                  <li><span>Độ phân giải màn hình
                      :</span><?php echo $row['sr'] ?></li>
                </ul>
              </div>
              <div class="product-availabily-option mt-15 mb-15">
                <div class="color-optionn">
                  <h4><sup>*</sup>Màu: <span
                      id="show_color"><?php echo $row['dcolor1'] ?></span></h4>
                  <ul>
                    <?php
                  ...
                  <tr class="">
                    <td style="border: none">
                      ...
                      <div class="product-qty">
                        <input style="border: 1px solid #f8f9fa" type="text"
                          id="quantity" value="1">
                        <span class="dec qtybtn"><i
                            class="fa fa-minus"></i></span><span
                          class="inc qtybtn"><i class="fa fa-plus"></i></span>
                      </div>
                    </td>
              ...
              <div class="pro-quantity-box mb-30">
                <div class="qty-boxx">
                  <button id="btn_addToCart" class="btn btn-secondary">Thêm vào
                    giỏ</button>
                </div>
              </div>
              ...
              <div class="tag-line mb-20">
                ...
                <a href="{{route('apple')}}">{{$row['manufacturer']}}</a>
                @elseif ($row['manufacturer'] == "Xiaomi")
                <a href="{{route('xiaomi')}}">{{$row['manufacturer']}}</a>
                @elseif ($row['manufacturer'] == "Samsung")
                <a href="{{route('samsung')}}">{{$row['manufacturer']}}</a>
                @elseif ($row['manufacturer'] == "Oppo")
                <a href="{{route('oppo')}}">{{$row['manufacturer']}}</a>
                @elseif($row['manufacturer'] == "Vsmart")
                <a href="{{route('vsmart')}}">{{$row['manufacturer']}}</a>
                @endif
              </div>
              <script>
              $(document).ready(function() {
                ...
                $("#color1").click(function() {
                  ...
                  $.ajax({
                    url: "{{route('cap-nhap-gia-ung-voi-mau')}}",
                    type: "get",
                    dataType: "text",
                    data: {
                      pid: pid,
                  ...
                  $.ajax({
                    url: "{{route('cap-nhat-anh-lon-ung-voi-mau-chon')}}",
                    type: "get",
                    dataType: "text",
                    data: {
                      pid: pid,
                  ...
                  $.ajax({
                    url: "{{route('cap-nhat-anh-nho-ung-voi-mau-da-chon')}}",
                    type: "get",
                    dataType: "text",
                    data: {
                      pid: pid,
                    ...
                    $.ajax({
                      ...
                      success: function(result) {
                        if (result === "1") {
                          ...
                          $.ajax({
                            url: "{{route('cap-nhap-so-luong-tren-cart-icon')}}",
                            type: "get",
                            dataType: "text",
                            data: {
                              customer: customer
        ...
        <div style="height: 370px;" class="product-item mb-30">
          <div class="product-thumb">
            <a href="product-details?pid=<?php echo $rowRelate['pid'] ?>">
              <img style="height: 150px; width: 150px;"
                src="product_images_desc/<?php echo $rowRelate['photo_color1'] ?>"
                class="pri-img" alt="">
              <img style="height: 150px; width: 150px;"
                src="product_images_desc/<?php echo $rowRelate['photo_color1'] ?>"
                class="sec-img" alt="">
          ...
          <div class="product-caption">
            ...
            <div class="product-name">
              <h4><a
                  href="product-details?pid=<?php echo $rowRelate['pid'] ?>"><?php echo $rowRelate['name'] ?></a>
              </h4>
            </div>
            <div class="ratings">
              <?php
            ...
            <ul class="nav nav-pills justify-content-center" id="pills-tab"
              ...
              <li class="nav-item">
                <a class="nav-link active" id="nav_desctiption"
                  data-toggle="pill" role="tab" aria-controls="tab_description"
          ...
          <div class="product-info mt-half">
            <ul class="nav nav-pills justify-content-center" id="pills-tab"
              ...
              <li class="nav-item">
                <a class="nav-link active" id="nav_desctiption"
                  data-toggle="pill" role="tab" aria-controls="tab_description"
                  aria-selected="true">Đánh giá - nhận xét từ khách hàng</a>
              </li>
            </ul>
          </div>
              ...
              <div class="form-group row">
                <div class="col">
                  <label class="col-form-label"><span
                      class="text-danger">*</span> Nhận xét của bạn</label>
                  <textarea class="form-control"
                    id="content_reviews"></textarea>
                </div>
              </div>
              <div id="rating_active" class="form-group row">
                <div class="col">
                  <label class="col-form-label"><span
                      class="text-danger">*</span> Đánh giá</label>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  <input type="hidden" id="value_verypoor" value="1">
                  <i style="cursor: pointer; color: yellow;"
                    id="rating_verypoor" class="far fa-star"></i>
                  &nbsp;
                  <input type="hidden" id="value_poor" value="2">
                  <i style="cursor: pointer;color: yellow;" id="rating_poor"
                    class="far fa-star"></i>
                  &nbsp;
                  <input type="hidden" id="value_average" value="3">
                  <i style="cursor: pointer;color: yellow;" id="rating_average"
                    class="far fa-star"></i>
                  &nbsp;
                  <input type="hidden" id="value_good" value="4">
                  <i style="cursor: pointer;color: yellow;" id="rating_good"
                    class="far fa-star"></i>
                  &nbsp;
                  <input type="hidden" id="value_excellent" value="5">
                  {{-- <i id="rating_excellent" style="color: yellow;" class="fas fa-star-half-alt"></i> --}}
                  <i style="cursor: pointer;color: yellow;"
                    id="rating_excellent" class="far fa-star"></i>
                  &nbsp;<span id="rating_choose">Tuyệt vời</span>
                </div>
              </div>
              <div class="buttons">
                <button id="btn_reviews" class="btn-cart rev-btn"
  ...
  $(document).ready(function() {
    ...
    $.ajax({
      url: "{{route('kiem-tra-san-pham-co-bi-xoa')}}",
      type: "get",
      dataType: "text",
      data: {
        pid: pid
...
{{-- Login --}}
{{-- <button id="btn_login_quick" style="width:auto;">Login</button> --}}


{{-- Hiển thị thông báo khi login thành công --}}
<div style="z-index: 2000" id="form_msg_login" class="modal">
  <form style="width: 20%; background-color: #fedc19;"
...
<div style="z-index: 2000" id="form_id" class="modal">
  ...
  <form class="modal-content animate" id="form_login_quick">
    <div class="imgcontainer">
      ...
      <span id="btn_close_form_login_quick" class="close"
    ...
    <div class="container">
      <div class="user-form">
        ...
        <input class="user-form__input" type="text" placeholder="Tài khoản"
          name="uname" id="username_login_quick">
      </div>
      ...
      <div class="user-form">
        ...
        <input class="user-form__input" type="password" placeholder="Mật khẩu"
          name="psw" id="password_login_quick">
      </div>
      ...
      <button class="form-btn" id="btn_login_quick_submit" type="submit">Đăng
        nhập</button>
    </div>
  </form>
</div>
...
{{-- <button id="btn_register_quick" style="width:auto;">Signup</button> --}}
...
<div style="z-index: 2000" id="form_id_register" class="modal">
  ...
  <form class="modal-content animate" id="form_register_quick">
    <div class="imgcontainer">
      ...
      <span id="btn_close_form_register_quick" class="close"
        title="Close Modal">&times;</span>
    </div>
    ...
    <div class="container">
      <div class="user-form">
        ...
        <input class="user-form__input" type="text" placeholder="Tên tài khoản"
          name="uname" id="username_register_quick">
      </div>
      ...
      <div class="user-form">
        ...
        <input class="user-form__input" type="password" placeholder="Mật khẩu"
          name="psw" id="password_register_quick">
      </div>
      ...
      <div class="user-form">
        ...
        <input class="user-form__input" type="password"
          placeholder="Nhập lại mật khẩu" name="psw"
          id="cpassword_register_quick">
      </div>
      <div class="psw-wrap">
        <span class="psw">
      ...
      <button class="form-btn" id="btn_register_quick_submit" type="submit">Đăng
        ký</button>
    </div>
  </form>
</div>

{{-- Xử lý login signup mobal --}}
<script>
$(document).ready(function() {
  $("#form_msg_login").hide();
  ...
  $("#btn_register_quick_submit").click(function() {
    ...
    if (usernameNew.length < username.length) {
      alert(
        "Tên tài khoản không cho phép ký tự đặc biệt hoặc khoảng trắng"
        );
      return false;
    }

    $.ajax({
      url: "{{route('register-quick')}}",
      type: "get",
      dataType: "text",
      data: {
        username: username,
