...
<body>
    ...
    <div class="sa-app sa-app--desktop-sidebar-shown sa-app--mobile-sidebar-hidden sa-app--toolbar-fixed">
        ...
        <div class="sa-app__sidebar">
            <div class="sa-sidebar">
                <div style="background-color: white;" class="sa-sidebar__header"><a class="sa-sidebar__logo" href="http://localhost:8080/ThucTapTwo/Admin/">
                        <!-- logo -->
                    ...
                    <ul class="sa-nav sa-nav--sidebar" data-sa-collapse="">
                        <li class="sa-nav__section">
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--root">
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"><a href="http://localhost:8080/ThucTapTwo/Admin/" class="sa-nav__link"><span class="sa-nav__icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                                            ...
                                            </svg></span><span class="sa-nav__title">Bảng điều khiển</span></a></li>
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" class="sa-nav__link" data-sa-collapse-trigger=""><span class="sa-nav__icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                                            ...
                                            </svg></span><span class="sa-nav__title">Quản lý sản phẩm</span><span class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="6" height="9" viewBox="0 0 6 9" fill="currentColor">
                                    ...
                                    <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                        <li class="sa-nav__menu-item"><a href="http://localhost:8080/ThucTapTwo/Admin/app-product-list" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh sách sản phẩm</span></a></li>
                                        
                                        <li class="sa-nav__menu-item"><a href="http://localhost:8080/ThucTapTwo/Admin/app-category-list" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh mục sản phẩm</span></a></li>
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" class="sa-nav__link" data-sa-collapse-trigger=""><span class="sa-nav__icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                                            ...
                                            </svg></span><span class="sa-nav__title">Khách hàng</span><span class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="6" height="9" viewBox="0 0 6 9" fill="currentColor">
                                                <path d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                                </path>
                                            </svg></span></a>
                                    <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                        <li class="sa-nav__menu-item"><a href="http://localhost:8080/ThucTapTwo/Admin/app-customer-list" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh sách khách hàng</span></a></li>
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" class="sa-nav__link" data-sa-collapse-trigger=""><span class="sa-nav__icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                                            ...
                                            </svg></span><span class="sa-nav__title">Đơn đặt hàng</span><span class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="6" height="9" viewBox="0 0 6 9" fill="currentColor">
                                                <path d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                                </path>
                                            </svg></span></a>
                                    <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                        <li class="sa-nav__menu-item"><a href="http://localhost:8080/ThucTapTwo/Admin/app-order-list" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh sách đơn đặt hàng</span></a></li>
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" class="sa-nav__link" data-sa-collapse-trigger=""><span class="sa-nav__icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor">
                                            ...
                                            </svg></span><span class="sa-nav__title">Khuyến mãi</span><span class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="6" height="9" viewBox="0 0 6 9" fill="currentColor">
                                                <path d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                                </path>
                                            </svg></span></a>
                                    <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                        <li class="sa-nav__menu-item"><a href="http://localhost:8080/ThucTapTwo/Admin/app-discount-list" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh sách khuyến mãi</span></a></li>
                                        <li class="sa-nav__menu-item"><a href="http://localhost:8080/ThucTapTwo/Admin/app-code-list" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh sách mã giảm giá</span></a></li>
                                ...
                                <li>
                                    <ul class="sa-nav__menu sa-nav__menu--root">
                                        <li style="position: absolute; bottom: 0;" class="sa-nav__menu-item sa-nav__menu-item--has-icon"><a id="my-logout" style="width: 240px;" href="http://localhost:8080/ThucTapTwo/Admin/logout" class="sa-nav__link"><span class="sa-nav__icon"><i class="fas fa-sign-out-alt"></i></span><span class="sa-nav__title">Đăng xuất</span></a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                ...
                <div class="sa-toolbar__body">
                    ...
                    <div class="dropdown sa-toolbar__item"><button class="sa-toolbar-user" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" data-bs-offset="0,1" aria-expanded="false"><span class="sa-toolbar-user__avatar sa-symbol sa-symbol--shape--rounded"><img src="../Admin/images/user1.png" width="64" height="64" alt="" /></span><span class="sa-toolbar-user__info"><span class="sa-toolbar-user__title">
                        ...
                        <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item" href="http://localhost:8080/ThucTapTwo/Admin/change-password">Đổi mật khẩu</a></li>
                            <li>
                                <hr class="dropdown-divider" />
                            </li>
                            <li><a class="dropdown-item" href="http://localhost:8080/ThucTapTwo/Admin/logout">Đăng xuất</a></li>
                        </ul>
                    </div>
                </div>
                <div class="sa-toolbar__shadow"></div>
            </div><!-- sa-app__toolbar / end -->
            <input type="hidden" id="loginadmin" value="<?php echo e($admin); ?>">
            <!-- sa-app__body -->
                                ...
                                <div class="col">
                                    <nav class="mb-2" aria-label="breadcrumb">
                                        <ol class="breadcrumb breadcrumb-sa-simple">
                                            <li class="breadcrumb-item"><a href="http://localhost:8080/ThucTapTwo/Admin/">Trang chủ</a></li>
                                            <li class=""><a
                                                    href="http://localhost:8080/ThucTapTwo/Admin/app-customer-list"> / Danh sách khách hàng</a></li>
                                            <li class="" aria-current="page"> / Cập nhật khách hàng</li>
                                        </ol>
                                    </nav>                   
                                </div>
                        ...
                        <div class="sa-entity-layout"
                            ...
                            <div class="sa-entity-layout__body">
                                <div class="sa-entity-layout__main">
                                    <div class="card">
                                        ...
                                        <div class="card-body p-5">                                          
                                            <div class="mb-4"><label for="form-category/name"
                                                    class="form-label">Tên tài khoản</label><input id="username" type="text"
                                                    class="form-control" value="<?php echo $row['username'] ?>" disabled/>
                                            </div>
                                            
                                            <div class="mb-4"><label for=""
                                                    class="form-label">Mật khẩu</label><input type="password" value="<?php echo $row['password'] ?>"
                                                    id="password" class="form-control"
                                                    />
                                            </div>
                                            <div class="mb-4"><label for=""
                                                    class="form-label">Nhập lại mật khẩu</label><input type="password"
                                                    id="cpassword" class="form-control" value="<?php echo $row['password'] ?>"
                                                    />
                                            </div>
                                            <div class="mb-4">
                                                <div class="mb-5">
                                                ...
                                                <div class="mb-n2 mt-n3">
                                                    <?php
                                                        if($row['delete_at'] == NULL){
                                                            echo '<label style="cursor: pointer;" id="user_active" class="form-check">
                                                            <input type="radio" class="form-check-input" name="status" checked/>
                                                            <span class="form-check-label">Hoạt động</span>
                                                            </label>
                                                            <label style="cursor: pointer;" id="user_noactive" class="form-check mb-0">
                                    ...
                                    <a id="btn_editCustomer" class="btn btn-primary">Cập nhật</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="../Admin/vendor/air-datepicker/js/i18n/datepicker.en.js"></script>
    ...
    <script src="../Admin/vendor/datatables/js/dataTables.bootstrap5.min.js"></script>
...
<script>
    $(document).ready(function(){
        ...
        if(loginadmin == "no login admin"){
            window.location.href = "http://localhost:8080/ThucTapTwo/Admin/login-admin";
        }
        //Lấy status
        ...
        $("#btn_editCustomer").click(function(){
            ...
            $.ajax({
                url: "<?php echo e(route('sua-tai-khoan-khach-hang')); ?>",
                type: "post",
                dataType: "text",
                data: {
                    username: username,
                ...
                success: function(result){
                    if(result == "error1"){
                        ...
                        window.location.href = "http://localhost:8080/ThucTapTwo/Admin/app-customer-list";
                    }
                }
            });
        });
...
<?php
    ob_flush();
?><?php /**PATH D:\xampp\htdocs\ThucTapTwo\resources\views/edit-customer.blade.php ENDPATH**/ ?>