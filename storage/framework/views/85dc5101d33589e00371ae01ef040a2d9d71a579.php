                ...
                <div class="col-lg-12">
                    <div class="newsletter-box">
                        <div class="newsletter-inner">
                            ...
                            <div class="newsletter-box">  
                                <input type="email" id="mc-email" autocomplete="off" class="email-box" placeholder="nhập email">
                                <button class="newsletter-btn" type="submit" id="">Đăng ký !</button>   
                            </div>
                        </div>
                        ...
                        <div class="widget-body">
                            <div class="footer-useful-link">
                                <ul>
                                    ...
                                    <li><span>Số điện thoại:</span> <strong>0000.000.000</strong></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
</script><?php /**PATH D:\xampp\htdocs\ThucTapTwo\resources\views/layout/footer.blade.php ENDPATH**/ ?>