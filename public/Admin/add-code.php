...
<head>
  ...
  <title>Thêm mã giảm giá</title><!-- icon -->
        ...
        <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
          <div class="container container--max--xl">
                ...
                <div class="col">
                  <nav class="mb-2" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-sa-simple">
                      ...
                      <li class="" aria-current="page"> / Thêm mã giảm giá</li>
                    </ol>
                  </nav>
                </div>
                  ...
                  <div class="card">
                    <div class="card-body p-5">
                      ...
                      <div class="mb-4"><label for="form-coupon/value"
                          ...
                          class="form-control" id="get_value" /></div>
                      <div class="mb-4">
                        <div class="mb-5">
                          <h2 class="form-label">Trạng thái</h2>
                        </div>
                        <div class="mb-n2 mt-n3">
                          <label style="cursor: pointer;" id="code_active"
                            class="form-check">
                            <input type="radio" class="form-check-input"
                              name="status" checked="" />
                            <span class="form-check-label">Hoạt động</span>
                          </label>
                          <label style="cursor: pointer;" id="code_none"
            ...
            <div style="margin-top: 20px;" class="col-auto d-flex">
              <a id="btn_addCode" class="btn btn-primary">Thêm</a>
            </div>
          </div>
        </div>
...
$(document).ready(function() {
  ...
  $("#btn_addCode").click(function() {
    ...
    //Gửi ajax
    $.ajax({
      url: "Controller/ControllerAddCode.php",
      type: "get",
      dataType: "text",
      data: {
        code: code,
