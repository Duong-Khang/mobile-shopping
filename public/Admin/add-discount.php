...
<head>
  ...
  <title>Thêm khuyến mãi</title><!-- icon -->
          ...
          <div class="container container--max--xl">
                ...
                <div class="col">
                  <nav class="mb-2" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-sa-simple">
                      ...
                      <li class="" aria-current="page"> / Thêm khuyến mãi</li>
                    </ol>
                  </nav>
                </div>
            ...
            <div class="sa-entity-layout"
                  ...
                  <div class="card w-100">
                    <div class="card-body p-5">
                      <div class="mb-4"><label for="form-coupon/start-date"
                          ...
                          data-auto-close="true" data-language="en" /></div>
              ...
              <div style="margin-top: 20px;" class="col-auto d-flex">
                <a id="btn_addDiscount" class="btn btn-primary">Thêm</a>
              </div>
            </div>
          </div>
        </div>
...
$(document).ready(function() {
  ...
  $("#btn_addDiscount").click(function() {
    ...
    //Kiểm tra xem discount có tồn tại chưa
    $.ajax({
      url: "Controller/ControllerCheckDiscountAdd.php",
      type: "get",
      dataType: "text",
      data: {
      ...
      success: function(resultCheck) {
        if (resultCheck == 0) {
          alert("Khuyến mãi đã tồn tại, thêm khuyến mãi khác");
        } else {
          $.ajax({
            url: "Controller/ControllerAddDiscount.php",
            type: "get",
            dataType: "text",
            data: {
              discount_name: discount_name,
