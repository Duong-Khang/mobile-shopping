                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr id="row_<?php echo $rowGetItemCart['cartid'] ?>">
                                                                <td>
                                                                    <a href="product-details?pid=<?php echo $rowGetItemCart['pid'] ?>"><img style="border: none;" src="product_images_desc/<?php
                                                                                                                                                                                            ...
                                                                                                                                                                                            ?>" alt="Cart Product Image" title="<?php echo $rowGetItemCart['name'] ?>" class="img-thumbnail"></a>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <div class="input-group btn-block">
                                                                        <div id="msg_<?php echo $rowGetItemCart['cartid'] ?>" class="product-qtyy mr-3">
                                                                            <input style="border: 1px solid #dee2e6;" type="text" id="quantity_<?php echo $rowGetItemCart['cartid'] ?>" value="<?php echo $rowGetItemCart['quantity'] ?>">
                                                                            <span style="cursor: pointer" id="btn_dec_<?php echo $rowGetItemCart['cartid'] ?>" class="dec qtybtn">
                                                                                <i class="fas fa-minus" aria-hidden="true"></i>
                                                                            </span>
                                                                            <span style="cursor: pointer" id="btn_inc_<?php echo $rowGetItemCart['cartid'] ?>" class="inc qtybtn">
                                                                                <i class="fas fa-plus" aria-hidden="true"></i>
                                                                            </span>
                                                                            <p id="msgtext_<?php echo $rowGetItemCart['cartid'] ?>" style="font-size: 12px"></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td id="show_totalOfItem_<?php echo $rowGetItemCart['cartid'] ?>"><?php
                                                                ...
                                                                <td>
                                                                    <span class="input-group-btn">
                                                                        <button id="btn_delete_product_<?php echo $rowGetItemCart['cartid'] ?>" style="border-radius: 5%;" type="button" class="btn btn-danger"><i class="fas fa-times-circle"></i></button>
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                            <input type="hidden" id="pid_<?php echo $rowGetItemCart['cartid'] ?>" value="<?php echo $rowGetItemCart['pid'] ?>">
                                                            <input type="hidden" id="color_<?php echo $rowGetItemCart['cartid'] ?>" value="<?php echo $rowGetItemCart['color'] ?>">
                                                            <script>
                                                                //Xử lý tăng, giảm, nhập số lượng mới, xóa item
                                                                $(document).ready(function() {
                                                                    //Event delay keyup để nhập số lượng mới
                                                                    var timeout = null;
                                                                    $("#quantity_<?php echo $rowGetItemCart['cartid'] ?>").keyup(function() {
                                                                        clearTimeout(timeout);
                                                                        timeout = setTimeout(function() {
                                                                            // Lấy quantity
                                                                            var quantityKeyup = $('#quantity_<?php echo $rowGetItemCart['cartid'] ?>').val();

                                                                            if (!quantityKeyup) {
                                                                                $("#msg_<?php echo $rowGetItemCart['cartid'] ?>").css("border", "1px solid tomato");
                                                                                $("#msgtext_<?php echo $rowGetItemCart['cartid'] ?>").text("Chưa nhập số lượng");
                                                                                return false;
                                                                            }
                                                                            if (quantityKeyup <= 0) {
                                                                                $("#msg_<?php echo $rowGetItemCart['cartid'] ?>").css("border", "1px solid tomato");
                                                                                $("#msgtext_<?php echo $rowGetItemCart['cartid'] ?>").text("Không được nhỏ hơn không");
                                                                                return false;
                                                                            }
                                                                            if (Number.isInteger(quantityKeyup) == false) {
                                                                                quantityKeyup = Number(quantityKeyup);
                                                                                if (Number.isInteger(quantityKeyup) == false) {
                                                                                    $("#msg_<?php echo $rowGetItemCart['cartid'] ?>").css("border", "1px solid tomato");
                                                                                    $("#msgtext_<?php echo $rowGetItemCart['cartid'] ?>").text("Không hợp lệ");
                                                                                    return false;
                                                                                }
                                                                            }
                                                                            $("#msg_<?php echo $rowGetItemCart['cartid'] ?>").css("border", "1px solid #dee2e6");
                                                                            $("#msgtext_<?php echo $rowGetItemCart['cartid'] ?>").text("");
                                                                            //Gửi ajax cập nhật lại

                                                                            //Lấy customer
                                                                            var customer = $("#userLogin").val();
                                                                            //Lấy pid
                                                                            var pid = $("#pid_<?php echo $rowGetItemCart['cartid'] ?>").val();
                                                                            //Lấy màu
                                                                            var color = $("#color_<?php echo $rowGetItemCart['cartid'] ?>").val();
                                                                            //Setup ajax
                                                                            $.ajaxSetup({
                                                                                headers: {
                                                                            ...
                                                                            $.ajax({
                                                                                url: "<?php echo e(route('cap-nhap-so-luong-delay-keyup')); ?>",
                                                                                type: "get",
                                                                                dataType: "text",
                                                                                data: {
                                                                                    customer: customer,
                                                                                ...
                                                                                success: function(resultUpdateKeyup) {
                                                                                    if (resultUpdateKeyup != "error1") {
                                                                                        ...
                                                                                        $.ajax({
                                                                                            url: "<?php echo e(route('cap-nhat-tong-cua-tung-item')); ?>",
                                                                                            type: "get",
                                                                                            dataType: "text",
                                                                                            data: {
                                                                                                customer: customer,
                                                                                            ...
                                                                                            success: function(resultUpdateTotalOfItem) {
                                                                                                $("#show_totalOfItem_<?php echo $rowGetItemCart['cartid'] ?>").text(resultUpdateTotalOfItem);
                                                                                            }
                                                                                        });
                                                                                        ...
                                                                                        $.ajax({
                                                                                            url: "<?php echo e(route('thanh-tien')); ?>",
                                                                                            type: "get",
                                                                                            dataType: "text",
                                                                                            data: {
                                                                                                customer: customer
                                                                    ...
                                                                    //Xóa
                                                                    $("#btn_delete_product_<?php echo $rowGetItemCart['cartid'] ?>").click(function() {
                                                                        ...
                                                                        if (answer) {
                                                                            ...
                                                                            $.ajax({
                                                                                url: "<?php echo e(route('xoa-san-pham')); ?>",
                                                                                type: "get",
                                                                                dataType: "text",
                                                                                data: {
                                                                                    customer: customer,
                                                                                ...
                                                                                success: function(result) {
                                                                                    if (result == "1") {
                                                                                        $("#row_<?php echo $rowGetItemCart['cartid'] ?>").remove();
                                                                                        //Gửi ajax để cập nhật lại thành tiền
                                                                                        //Lấy customer
                                                                                        var customer = $("#userLogin").val();
                                                                                        $.ajaxSetup({
                                                                                        ...
                                                                                        $.ajax({
                                                                                            url: "<?php echo e(route('kiem-tra-mua-hang')); ?>",
                                                                                            type: "get",
                                                                                            dataType: "text",
                                                                                            data: {
                                                                                                customer: customer
                                                                    ...
                                                                    //Tăng số lượng
                                                                    $("#btn_inc_<?php echo $rowGetItemCart['cartid'] ?>").click(function() {
                                                                        //Lấy customer
                                                                        var customer = $("#userLogin").val();
                                                                        //Lấy pid
                                                                        var pid = $("#pid_<?php echo $rowGetItemCart['cartid'] ?>").val();
                                                                        ...
                                                                        var quantity = $("#quantity_<?php echo $rowGetItemCart['cartid'] ?>").val();
                                                                        //Kiểm tra số lượng xem có hợp lệ không
                                                                        if (!quantity) {
                                                                            alert("Chưa nhập số lượng");
                                                                            //Lấy số lượng
                                                                            $.ajax({
                                                                                url: "<?php echo e(route('lay-so-luong')); ?>",
                                                                                type: "get",
                                                                                dataType: "text",
                                                                                data: {
                                                                                    customer: customer,
                                                                                ...
                                                                                success: function(resultGetQuantity) {
                                                                                    $("#quantity_<?php echo $rowGetItemCart['cartid'] ?>").val(resultGetQuantity);
                                                                                }
                                                                            });
                                                                            return false;
                                                                        } else if (quantity <= 0) {
                                                                        ...
                                                                        $.ajax({
                                                                            url: "<?php echo e(route('cap-nhat-lai-so-luong-khi-tang')); ?>",
                                                                            type: "get",
                                                                            dataType: "text",
                                                                            data: {
                                                                                customer: customer,
                                                                            ...
                                                                            success: function(resultUpdateQuantity) {
                                                                                if (resultUpdateQuantity == "error1") {
                                                                                    alert("Số lượng không đủ đáp ứng");
                                                                                } else if (resultUpdateQuantity == "error2") {
                                                                                    alert("Tăng số lượng thất bại");
                                                                                } else {
                                                                                    $("#quantity_<?php echo $rowGetItemCart['cartid'] ?>").val(resultUpdateQuantity);
                                                                    ...
                                                                    //Giảm số lượng
                                                                    $("#btn_dec_<?php echo $rowGetItemCart['cartid'] ?>").click(function() {
                                                                        //Lấy customer
                                                                        var customer = $("#userLogin").val();
                                                                        //Lấy pid
                                                                        var pid = $("#pid_<?php echo $rowGetItemCart['cartid'] ?>").val();
                                                                        ...
                                                                        $.ajax({
                                                                            url: "<?php echo e(route('cap-nhat-lai-so-luong-khi-giam')); ?>",
                                                                            type: "get",
                                                                            dataType: "text",
                                                                            data: {
                                                                                customer: customer,
                                                                            ...
                                                                            success: function(resultUpdateQuantity) {
                                                                                if (resultUpdateQuantity == "error1") {
                                                                                    ...
                                                                                    alert("Tăng số lượng thất bại");
                                                                                } else if (resultUpdateQuantity == "error3") {
                                                                                    var answer = window.confirm("Xóa sản phẩm này?");
                                                                                    if (answer) {
                                                                                        //Xóa
                                                                                        //alert("Xóa");
                                                ...
                                                <table class="table table-bordered">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td id="subTotal"><?php echo number_format($total); ?> đ</td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Tổng cộng:</strong></td>
                                                            <td><span id="total" class="color-primary"><?php echo number_format($total); ?> đ</span></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
...
</script><?php /**PATH D:\PHP\xampp\htdocs\ThucTapTwo\resources\views/cart.blade.php ENDPATH**/ ?>