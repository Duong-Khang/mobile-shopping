    ...
    <div class="pro-module-four-active owl-carousel owl-arrow-style">
      ...
      <div style="margin-bottom: 15px;" class="product-module-four-item">
        <div style="height: 150px;" class="product-module-caption">
          ...
          <input type="hidden" name="" id="pid___<?php echo $row['id'] ?>"
          ...
          $(document).ready(function() {
            ...
            $.ajax({
              ...
              success: function(result) {
                $("#show_star___<?php echo $row['id'] ?>").html(
                  result);
              }
            });
          });
...
</div><?php /**PATH D:\PHP\xampp\htdocs\ThucTapTwo\resources\views/layout/home-product-module-six.blade.php ENDPATH**/ ?>