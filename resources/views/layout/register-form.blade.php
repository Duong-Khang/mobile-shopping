      ...
      <div class="col-12 col-sm-12 col-md-12 col-lg-12">
        <main id="primary" class="site-main">
          <div class="user-login">
            ...
            <div class="row">
              <div
                class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-8 offset-xl-2">
                <div class="registration-form login-form">
                  {{-- <form action="{{route('xu-ly-dang-ky')}}" method="POST">
                  @csrf --}}
                  <div class="login-info mb-20">
                    <p>Đã có tài khoản? <a style="color: #007bff;"
                        href="{{route('dang-nhap')}}">Đăng nhập!</a></p>
                  </div>

                  <div class="form-group row">
                    <label for="email"
                      class="col-12 col-sm-12 col-md-4 col-form-label">Tên tài
                      khoản</label>
                  ...
                  <div class="form-group row">
                    <label for="newpassword"
                      class="col-12 col-sm-12 col-md-4 col-form-label">Mật
                      khẩu</label>
                    <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                      <input type="password" class="form-control"
                        name="password" id="password">
                      <button class="pass-show-btn" id="btn_showPassword"
                        type="button">Hiển thị</button>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="c-password"
                      class="col-12 col-sm-12 col-md-4 col-form-label">Xác thực
                      mật khẩu</label>
                    <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                      <input type="password" class="form-control"
                        name="cpassword" id="cpassword">
                      <button class="pass-show-btn" id="btn_showCpassword"
                        type="button">Hiển thị</button>
                    </div>
                  </div>
                  ...
                  <div class="register-box d-flex justify-content-end mt-20">
                    <button type="submit" id="btn_register"
                      class="btn btn-secondary">Đăng ký</button>
                  </div>
                  {{-- </form> --}}
                </div>
              </div>
