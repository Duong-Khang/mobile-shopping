        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
          <main id="primary" class="site-main">
            <div class="user-login">
              ...
              <div class="row">
                <div
                  class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-6 offset-lg-2 offset-xl-3">
                    ...
                    <div class="form-group row align-items-center mb-4">
                      ...
                      <div class="col-12 col-sm-12 col-md-8">
                        <input type="password" class="form-control"
                          id="passwordOld" placeholder="Mật khẩu cũ">
                        {{-- <button class="pass-show-btn" id="showPasswordOld" type="button">Hiển thị</button> --}}
                      </div>
                    </div>
                    <div class="form-group row align-items-center mb-4">
                      <label for="c-password"
                      ...
                      <div class="col-12 col-sm-12 col-md-8">
                        ...
                        {{-- <button class="pass-show-btn" id="showPasswordNew" type="button">Hiển thị</button> --}}
                      </div>
                    </div>
                    <div class="form-group row align-items-center mb-4">
                      <label for="c-password"
                        class="col-12 col-sm-12 col-md-4 col-form-label">Nhập
                        lại mật khẩu mới</label>
                      <div class="col-12 col-sm-12 col-md-8">
                        <input type="password" class="form-control"
                          id="cpasswordNew" placeholder="Nhập lại mật khẩu mới">
                        {{-- <button class="pass-show-btn" id="showPassword" type="button">Hiển thị</button> --}}
                      </div>
                    </div>
                    <div class="login-box mt-0 text-right">
                      <button type="submit" id="btn_changePassword"
                        class="btn btn-secondary mb-2 mt-0">Xác nhận</button>
                    </div>
