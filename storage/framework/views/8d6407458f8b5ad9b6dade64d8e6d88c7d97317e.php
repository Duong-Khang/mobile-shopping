  ...
  <div class="container-fluid">
    <div class="row align-items-center">
      <div class="col-lg-2 col-md-4 col-sm-4 col-12">
        <div class="logo">
          <a href="<?php echo e(route('/')); ?>"><img
              src="<?php echo e(asset('assets/img/logo/logo-mobile-shop.png')); ?>"
              alt="brand-logo"></a>
        </div>
      </div>
        ...
        <div class="mini-cart-option">
          <ul>
            <li id="cartMoveHover" class="my-cart">
              <a href="<?php echo e(route('gio-hang')); ?>" class="ha-toggle"
              ...
              <ul id="cartHover" class="mini-cart-drop-down ha-dropdown">
                ...
                <li style="margin: 0 0; padding: 0 0;" id="show_info_cart"
                  ...
                  <a style="padding: 0 0; margin: 0 0" class="cart-button"
                    href="<?php echo e(route('gio-hang')); ?>">Xem giỏ hàng và thanh toán</a>
                </li>
              </ul>
            </li>
          </ul>
...
</script><?php /**PATH D:\PHP\xampp\htdocs\ThucTapTwo\resources\views/layout/header-middle.blade.php ENDPATH**/ ?>